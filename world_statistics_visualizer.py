...
path_to_data_template = input("Enter path to root directory with data\n")
#path_to_data_template = "../thunderbolt_data/06/"
first_date = input("Enter starting date in format yyyy/mm/dd\n")
#first_date = "2016/06/01"
first_time = input("Enter starting time in format hh:mm:ss\n")
#first_time = "00:00:00"
second_date = input("Enter finish date in format yyyy/mm/dd\n")
#second_date = "2016/06/29"
second_time = input("Enter finish time in format hh:mm:ss\n")
#second_time = "23:59:59"
save_name = input("Enter name of result file\n")
...
try:
    ...
    input("Invalid starting date or time input. Press any key to exit\n")
    exit(0)
...
try:
    ...
    input("Invalid finish date or time input. Press any key to exit\n")
    exit(0)
...
try:
    ...
    input("Source image reading error. Press any key to exit\n")
    exit(0)
...
try:
    ...
    figure.save(save_name + ".jpg", "JPEG")
except Exception:
    input("Unpredictable error. Press any key to exit\n")
    exit(0)
